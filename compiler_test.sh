...
stmttest "while (c != EOF) {1;}" "1 AST_WHILE"
stmttest "int a;" "1 AST_STATEMENTS"
stmttest "return 1;" "1 AST_RETURN"
stmttest "int a = 1;" "1 AST_STATEMENTS"
...
funcdecltest "struct myptr { int* p; }; struct myptr* main() {}" "myptr p"
